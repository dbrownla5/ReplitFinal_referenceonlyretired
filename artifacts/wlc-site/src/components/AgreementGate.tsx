...
const AGREEMENT_SECTIONS: { h: string; b: string }[] = [
  ...
  { h: "3. Commission Split", b: "Commission is calculated on net sale price (sale price minus platform fees, shipping, and approved transaction costs). Client share by category: Clothing & Accessories 55%, Designer & Luxury 50%, Furniture & Significant Home 50%, Full Closet Liquidation 55%. Bags primarily of lower-value items may use an adjusted structure, reviewed and communicated before listing." },
